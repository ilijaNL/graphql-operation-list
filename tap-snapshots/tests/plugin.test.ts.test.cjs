 ...
 */
'use strict'
exports[`tests/plugin.test.ts TAP additional directives for custom prefix > must match snapshot 1`] = `
[
  {
    "behaviour": {
      "undefined": {
...
exports[`tests/plugin.test.ts TAP additional directives for default prefix > must match snapshot 1`] = `
[
  {
    "behaviour": {
      "abc": {
...
exports[`tests/plugin.test.ts TAP nested fragment > must match snapshot 1`] = `
[
  {
    "behaviour": {},
    "operationName": "user",
